...
!(function (exports){
    ...
    /**
     * Generic constructor for a CSR matrix instance.
     * @param  {JSON} objargs, can be in different format. Used by other contructors (which are recommended to be used).
     * @return {csr_matrix}
     */
    ...
    /**
     * Returns the array of row's pointers.
    ...
    /**
     * Function used by the constructor, setup the csr variables.
     * @param  {JSON} objargs
     */
    ...
    /**
     * Get the column value in the column array.
    ...
    /**
     * Get the row value in the represented matrix, starting from the index in the csr colums array.
     * The corresponding row index of the x-th element in the columns/values array
     * @param  {Unsigned Integer} index
     * @return {Unsigned Integer}      
     */
